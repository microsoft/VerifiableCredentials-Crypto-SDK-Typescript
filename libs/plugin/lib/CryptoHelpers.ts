...
import { PublicKey, EcPublicKey, JoseConstants, W3cCryptoApiConstants } from '@microsoft/crypto-keys';
  ...
  public static jwaToWebCrypto(jwa: string, ...args: any): any {
    ...
    switch (jwa.toUpperCase()) {
      ...
      case JoseConstants.Es256K:
        return { name: 'ECDSA', namedCurve: 'secp256k1', hash: { name: 'SHA-256' }, format: 'DER' };
      case JoseConstants.EdDSA:
        return { name: 'EDDSA', namedCurve: 'ed25519', hash: { name: 'SHA-256' } };
    }
