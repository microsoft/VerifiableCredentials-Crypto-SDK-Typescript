...
describe('KeyVaultPlugin', () => {
  ...
  it('should generate a key', async () => {
    ...
    try {
      const result: CryptoKeyPair = await plugin.onGenerateKey(alg, true, ['sign']);
  ...
  it('should generate a key and secret', async () => {
    ...
    try {
      ...
      // Generate EC
      let keyPair: CryptoKeyPair = await plugin.onGenerateKey(alg, true, ['sign', 'verify']);
  ...
  it('should sign a message', async () => {
    ...
    try {
      ...
      let keyPair: any = await plugin.onGenerateKey(alg, true, ['sign'], { name });
...
describe('rsa-oaep', () => {
  ...
  it('should decrypt a message', async () => {
    ...
    try {
      ...
      // generate key
      const keyPair: CryptoKeyPair = await plugin.onGenerateKey(alg, true, ['decrypt', 'encrypt']);
